...
class NetflixTransactionSuccessful extends StatelessWidget {
  static const String routeName = 'NetflixTransactionSuccessful';
  const NetflixTransactionSuccessful({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final accountName = args['name'] as String;
    final accountNumber = args['accountNumber'] as String;
    final imagePath = args['imagePath'] as String;
    final giftTitle = args['paymentType'] as String;
